---
description: Steps to transfer/wrap ECROX20 tokens from Ethereum to Fusenet
---

# Bridge for ECROX20 tokens

Please use this tutorial at your own risk as it involves using Etherscan UI/Ecrox explorer to relay the tokens.
