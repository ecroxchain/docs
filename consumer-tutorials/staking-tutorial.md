---
description: This tutorial will explain how to delegate/stake/unstake your ECROX.
---

# Staking tutorial

Note: You can only stake ECROX which is on Ecrox network. Please make sure you have changed into Ecrox network in Metamask while doing any transactions on staking UI. 

How to Stake Ecrox:

**Step 1:**

Navigate to staking.ecroxscan.com and login to your wallet through metamask. Make sure you are on Ecrox network. If you are not please follow the instructions [**here**](https://docs.ecroxscan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of ECROX you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 

![](../.gitbook/assets/3%20%286%29.png)

**How to Unstake ECROX:**
